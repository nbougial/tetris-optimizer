...
Use this file to track execution progress for all planned tasks.
...
- Move to `done` only when task done criteria are met.
- Use `blocked` with a short reason in commit message or PR note.
